  ...
  <section className="py-16 bg-white border-b border-gray-200">
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Why choose LearnTrack?</h2>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        <FeatureCard
          ...
          desc="Track your learning time automatically and get insights into your progress."
        />
        <FeatureCard
          icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>}
          title="Verified Certificates"
          desc="Earn certificates upon completion to showcase your achievements."
        />
        <FeatureCard
          icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>}
          title="Direct Messaging"
          desc="Connect with instructors and peers through our messaging system."
        />
        <FeatureCard
          ...
          desc="Visualize your learning progress with detailed analytics and reports."
        />
        <FeatureCard
          ...
          desc="Access courses on any device, anytime, anywhere."
        />
        <FeatureCard
